...
INTERNAL RULES — CRO CHECKLIST EVALUATION ENGINE
  ...
  "findings": [
    {
      ...
      "solutions": [
        "Simple, non-technical, actionable recommendations..."
      ],
      "recommended_apps": [
...
- The "section_name" field must contain ONLY the core section name.
- YOU MUST REMOVE all text inside parentheses (...) or brackets [...] from the section name.
- If a checklist item contains a hyphen '-' or colon ':' followed by a description, remove the description.
- PROHIBITED: Do not include insights, status, summary, issues, or parenthetical details in the title.
- INVALID: "Trust Signals (badges)", "Hero Section - Missing CTA", "Footer (Needs Improvement)"
- VALID: "Trust Signals", "Hero Section", "Footer"
